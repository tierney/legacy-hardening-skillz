...
## 1. Discovery Phase
Activate this skill when encountering legacy crypto/steganography code (e.g. Reed-Solomon, Bacchant, Aesthete). Performance is measured according to [Evaluation Metrics](evals/eval.yaml).
